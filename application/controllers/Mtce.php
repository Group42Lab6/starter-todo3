       ...
       public function add()
       {
        ...
        private function showit()
        {
            ...
            $fields = array(
                ...
                'fgroup' => makeComboBox('Group', 'group', $task->group, $groupparms, "Which group is this task?"),
                'fstatus' => makeComboBox('Status', 'status', $task->status, $statusparms, "Is this task done?"),
